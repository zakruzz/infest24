...
<div>
    <div class="content-heading pt-0">
        ...
        <nav class="breadcrumb push mb-0">
            ...
            <span class="breadcrumb-item active">Pelatihan</span>
        </nav>
    </div>
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                Tabel <small>Pelatihan</small>
            </h3>
        </div>
        <div class="block-content block-content-full">
            @include('sections.table.superuser.course')
        </div>
    </div>
    <a href="{{ route('superuser.course.create') }}" class="btn-float">
