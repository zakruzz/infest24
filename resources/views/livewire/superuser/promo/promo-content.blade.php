@section('title', $editMode ? 'Sunting Promo' : 'Tambah Promo')
@section('styles')
...
<div>
    <div class="content-heading pt-0">
        <h3 class="mb-0">{{ $editMode ? 'Sunting' : 'Tambah' }} Promo</h3>
        <nav class="breadcrumb push mb-0">
            <a class="breadcrumb-item" href="{{route('superuser.dashboard')}}">Beranda</a>
            <a class="breadcrumb-item" href="{{route('superuser.blog.index')}}">Promo</a>
