...
<div>
    <div class="content-heading pt-0">
        ...
        <nav class="breadcrumb push mb-0">
            ...
            <span class="breadcrumb-item active">Promo</span>
        </nav>
    </div>
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                Tabel <small>Daftar Promo</small>
            </h3>
        </div>
        <div class="block-content block-content-full">
            @include('sections.table.superuser.promo')
        </div>
    </div>
    <a href="{{ route('superuser.promo.create') }}" class="btn-float">
